...
### transaction结构 https://en.bitcoin.it/wiki/Transaction#General_format_.28inside_a_block.29_of_each_output_of_a_transaction_-_Txout
...
block rule 将文章https://en.bitcoin.it/wiki/Protocol_rules#.22tx.22_messages
